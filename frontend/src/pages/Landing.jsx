    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <nav className="flex justify-between items-center px-6 md:px-12 py-4">
        <div className="text-2xl font-bold text-indigo-700">
          Pay<span className="text-indigo-600">TM</span>
        </div>
      ...
      <main className="flex flex-col items-center justify-center text-center px-4 pt-24 md:pt-32 pb-16">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-gray-800 leading-tight">
          Fast, Secure
          <br />
          <span className="text-indigo-600">Money Transfers</span>
        </h1>
        <p className="mt-4 md:mt-6 text-base md:text-lg text-gray-600 max-w-xl leading-relaxed">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
          <button
            onClick={() => navigate("/signup")}
            className="px-8 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition text-base"
          >
            Get Started
          </button>
          <button
            onClick={() => navigate("/signin")}
            className="px-8 py-3 border border-gray-300 bg-white text-gray-700 font-medium rounded-lg hover:bg-gray-50 transition text-base"
          >
            Sign In
          </button>
        </div>
        ...
        <div className="mt-16 grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-4xl w-full px-4">
          {[
            ...
            <div
              key={i}
              className="bg-white rounded-xl p-6 shadow text-left border border-gray-100 hover:shadow-lg transition"
            >
